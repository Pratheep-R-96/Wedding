  ...
  if (icon === 'cross') {
    return (
      <svg width="48" height="48" viewBox="0 0 48 48" fill="none" aria-hidden="true">
        <line x1="24" y1="8" x2="24" y2="40" stroke="#C9A96E" strokeWidth="1.5" strokeLinecap="round" />
        <line x1="14" y1="18" x2="34" y2="18" stroke="#C9A96E" strokeWidth="1.5" strokeLinecap="round" />
      </svg>
    )
  }
  if (icon === 'ring') {
    return (
      <svg width="48" height="48" viewBox="0 0 48 48" fill="none" aria-hidden="true">
        <circle cx="18" cy="24" r="9" stroke="#C9A96E" strokeWidth="1.5" />
        <circle cx="30" cy="24" r="9" stroke="#C9A96E" strokeWidth="1.5" />
      </svg>
    )
  }
  if (icon === 'heart') {
    return (
      <svg width="48" height="48" viewBox="0 0 48 48" fill="none" aria-hidden="true">
        <path
          ...
          fill="none"
        />
        <path d="M18 14 Q20 12 24 16 Q28 12 30 14" stroke="#C9A96E" strokeWidth="0.75" fill="none" opacity="0.5" />
      </svg>
    )
  }
  return null
